...
public class Solution {
    ...
    public static void printDate(String date) {
        ...
        if (dateArray.length == 2) {
            ...
            dayMonthYear = dateArray[0].split("\\.");
            hourMinuteSecond = dateArray[0].split(":");
    ...
    private static void showTime(DateTime dateTime) {
    ...
    private static void showDate(DateTime dateTime) {
