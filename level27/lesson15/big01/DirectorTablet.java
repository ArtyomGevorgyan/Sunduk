...
public class DirectorTablet {
    ...
    public void printActiveVideoSet() {
        List<Advertisement> active = StatisticAdvertisementManager.getInstance().getActiveVideos();
    ...
    public void printArchivedVideoSet() {
        List<Advertisement> archive = StatisticAdvertisementManager.getInstance().getArchivedVideos();
        Collections.sort(archive, new Comparator<Advertisement>()
        {
            @Override
            public int compare(Advertisement o1, Advertisement o2)
            {
